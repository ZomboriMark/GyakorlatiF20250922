    ...
    return(
        ...
        <form onSubmit={kuldes}>
            <fieldset>
                ...
                <select name="evf" id="evf" value={user.evf} onChange={ e => setUser({...user,evf: e.target.value})}>
                ...
                <textarea name="megj" id="megj" value={user.megj} onChange={e => setUser({...user,megj: e.target.value})}/>
            </fieldset>
        </form>
